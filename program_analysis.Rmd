...
<div style="background:#eef5fc;border:1px solid #cdd9e6;border-radius:6px;padding:10px 14px;margin-bottom:1em;font-size:0.95em;">
<strong>R version</strong> of the notebook — also available as a
<a href="program_analysis_py.html">Python notebook</a> using
<a href="https://github.com/julielaffy/pyscalop">pyscalop</a>.
</div>
...
**`ThermoScores_cell.csv`** — 3 sampled rows of 30,975, showing 2 of the
12 raw + 12 z-scored signature columns:

```
                    cell_id  gene  emont.hAd6  z_emont.hAd6
PPARG_P2_TAACCTAGTGATGAGC-1 PPARG      0.0969        0.3058
 NFIB_P1_TATCCATCAAGTGGTT-1  NFIB     -0.4047       -1.2769
   NC_P5_CCATCGCTCTGTCATC-1    NC     -0.0095       -0.0300
```
